...
def main():
    ...
    print("\nNote: Position numbers in a list begine with 0, not with 1")
    ...
    print("\nRemoves a dog by name rather than position in the list:")
    print(dogs)
    ...
    print("\nUse a FOR loop to give each dog in the same last bane:")
    for i in range(len(dogs)):
        dogs[i] = dogs[i] + " Ajemian"
    print(dogs)
